import { BigintIsh, CurrencyAmount, Price, Token } from 'thena-sdk-core'
...
export class Pool {
  ...
  public constructor(
    ...
    this.tickDataProvider = Array.isArray(ticks) ? new TickListDataProvider(ticks, TICK_SPACING) : ticks
  }
