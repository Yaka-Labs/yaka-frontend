...
import { CurrencyAmount, BNB, JSBI } from 'thena-sdk-core'
    ...
    () =>
      currencies.map((currency) => {
        ...
        if (currency.isToken) {
          ...
          const amount = found && found.balance ? JSBI.BigInt(toWei(found.balance, found.decimals).toString(10)) : undefined
