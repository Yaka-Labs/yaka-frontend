...
const computeAllRoutes = (currencyIn, currencyOut, pools, chainId, currentPath, allPaths, startCurrencyIn = currencyIn, maxHops = 2) => {
...
export const useAllV3Routes = (currencyIn, currencyOut) => {
  ...
  return useMemo(() => {
    ...
    const routes = computeAllRoutes(currencyIn, currencyOut, pools, networkId, [], [], currencyIn, singleHopOnly || singleIfWrapped ? 1 : 3)
