...
import { setWeb3Instance, permit2Address, hasWeb3Instance, signEIP712, parsebn, zeroAddress, isNativeAddress } from '@defi.org/web3-candies'
import { MAX_UINT256, formatNumber, isInvalidAmount, toWei } from 'utils/formatNumber'
...
const useApprove = () => {
  ...
  return useCallback(
    async (srcToken, key, approveuuid) => {
      ...
      try {
        await sendContract(dispatch, key, approveuuid, tokenContract, 'approve', [permit2Address, MAX_UINT256], account)
