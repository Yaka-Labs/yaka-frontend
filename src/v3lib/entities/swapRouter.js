...
import { fusionRouterAbi } from 'config/abi/v3'
...
export class SwapRouter extends SelfPermit {
  static INTERFACE = new Interface(fusionRouterAbi)
          ...
          if (trade.tradeType === TradeType.EXACT_INPUT) {
            ...
            calldatas.push(
              SwapRouter.INTERFACE.encodeFunctionData(
                options.feeOnTransfer && !inputIsNative ? 'exactInputSingleSupportingFeeOnTransferTokens' : 'exactInputSingle',
