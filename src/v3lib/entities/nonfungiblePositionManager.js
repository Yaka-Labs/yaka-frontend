import { CurrencyAmount, validateAndParseAddress, JSBI } from 'thena-sdk-core'
...
export class NonfungiblePositionManager extends SelfPermit {
  static INTERFACE = new Interface(algebraAbi)
  ...
  static burnCallParameters(id) {
    ...
    return {
      calldata: NonfungiblePositionManager.INTERFACE.encodeFunctionData('burn', [tokenId]),
      value: toHex(0),
    }
  }
