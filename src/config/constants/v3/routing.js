...
import { Token, ChainId, WBNB } from 'thena-sdk-core'
...
export const USDT = {
  ...
  1328: toToken(routeAssets[1328].USDT),
  1329: toToken(routeAssets[1329].USDT),
}
const ETH = {
...
export const BASES_TO_CHECK_TRADES_AGAINST = {
  [ChainId.BSC]: [...WBNB_ONLY[ChainId.BSC], BUSD, USDC, USDT[ChainId.BSC], ETH[ChainId.BSC], FRAX, BNBx, ankrBNB, stkBNB, THE, USDPlus],
