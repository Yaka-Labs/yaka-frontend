  ...
  return (
    ...
    >
      ...
      <div className='flex flex-col mt-[6.8px] lg:mt-0 w-1/2 lg:w-[14%] items-start justify-center'>
        <p className='lg:hidden text-[11.9px] font-figtree font-semibold'>Projected APR</p>
        ...
        {account ? (
          <div className='space-x-[17px] xl:space-x-[20.4px] w-full flex items-center lg:justify-end'>
            ...
            <button
              ...
              className={`${item.account.gaugeEarned.isZero() || pending ? 'opacity-[0.33] cursor-not-allowed ' : ''}text-[13.6px] text-green`}
              onClick={() => {
                onHarvest(item)
              }}
            >
          ...
          <div className='w-full flex items-center lg:justify-end'>
            <TransparentButton
              ...
              className='h-[34px] px-[22.1px] w-full lg:max-w-[147.05px] whitespace-nowrap'
            />
          </div>
        )}
      </div>
