...
import { CurrencyAmount, Price, Rounding, JSBI, WBNB } from 'thena-sdk-core'
import { useDispatch, useSelector } from 'react-redux'
import { formatUnits, parseUnits } from 'ethers/lib/utils'
import { Pool, Position, TickMath, encodeSqrtRatioX96, nearestUsableTick, priceToClosestTick, tickToPrice } from 'thena-fusion-sdk'
import { PoolState, useFusion } from 'hooks/v3/useFusions'
...
import { maxAmountSpend, tryParseAmount, getTickToPrice } from 'v3lib/utils'
...
export const useV3DerivedMintInfo = (
  ...
  const independentAmount = tryParseAmount(
    typedValue,
    [FusionRangeType.GAMMA_RANGE, FusionRangeType.DEFIEDGE_RANGE].includes(liquidityRangeType) && independentCurrency && independentCurrency.isNative
